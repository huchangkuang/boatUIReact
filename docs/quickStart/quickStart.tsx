...
export const QuickStart: FC = () => {
  ...
  return <div>
    ...
    <div className={scm("desc")}>boat-ui 是一款轻量化的ui组件库</div>
    ...
    <div style={{marginTop: 16}} className={scm("sbuTitle")}>组件总览</div>
    <div className={sc('components')}>
      <div className={sc('components-item')}>
        <div className={sc('components-item-header')}>
          Icon 图标
        </div>
      ...
      <div className={sc('components-item')}>
        ...
        <div className={sc('components-item-body')}>
          <Layout>
            ...
            <Content style={{...layoutStyle,background: '#8FBC94'}}>content</Content>
